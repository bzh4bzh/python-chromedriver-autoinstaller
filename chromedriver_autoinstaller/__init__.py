...
def install(cwd: bool = False, path: Optional[AnyStr] = None, no_ssl: bool = False, version: str | None = None):
    """
    ...
    if cwd:
        path = os.getcwd()
    chromedriver_filepath = utils.download_chromedriver(path, no_ssl, version)
